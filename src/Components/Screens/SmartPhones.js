...
await firest.collection('Products').get().then((documentSnapshot)=>{
    documentSnapshot.forEach((doc)=>{
        const {name,
            ...
            tagline,
             Orders,
            count} = doc.data();
            if(category === "SmartPhones" && stock > 0)
            {
            list.push({
                name,
            id:id,
    ...
    this.setState({smartphones:list})
    }
  render() {
    ...
    <div>
      <Header/>
      <h1 class="text-center"  style={{color:'red',fontWeight:'bold'}}>Smart Phones</h1>
    <main>
    <head>
                    ...
                    <div className="block-body text-center">
                        ...
                        <div className="product-buttons mt-4">
                            <div className="row align-items-center">
                                ...
                                <div className="col-8">
                                    <button type="button" onClick={()=> {this.GoCart(product.id)}} className="btn btn-block btn-primary btn-circle btn-icon-left">
