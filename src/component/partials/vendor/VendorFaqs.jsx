    ...
    <div className="ps-section--vendor ps-vendor-faqs">
        <div className="container">
            <div className="ps-section__header">
                ...
                <h4>Here are some common questions about selling on M & H</h4>
            </div>
            <div className="ps-section__content">
                <div className="row">
                    <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 ">
                        <figure>
                            <figcaption>How do fees work on M & H?</figcaption>
                            <p>
                                Joining and starting a shop on M & H is free. Comission is charged on every sale
                            </p>
                            <p>
                        ...
                        <figure>
                            ...
                            <p>
                                It’s easy to set up a shop on M & H. Create an M & H account
                                (if you don’t already have one),  choose a shop name, create a listing, set a payment method
